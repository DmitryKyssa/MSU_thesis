...
public class MazeGenerator
{
    ...
    public static MazeGenerator Instance { get; private set; } = new MazeGenerator();
    ...
    private void RemoveWall(MazeGeneratorCell firstCell, MazeGeneratorCell secondCell)
    {
        if (firstCell.X == secondCell.X)
        {
            (firstCell.Y > secondCell.Y ? firstCell : secondCell).WallBottom = false;
        }
        else
        {
            (firstCell.X > secondCell.X ? firstCell : secondCell).WallLeft = false;
        }
    }
